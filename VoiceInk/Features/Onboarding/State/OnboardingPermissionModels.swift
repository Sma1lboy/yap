...
enum OnboardingStage: String, CaseIterable {
    ...
    var title: String {
        ...
        case .experience:
            return String(localized: "Experience Yap")
        case .contextAwareness:
    ...
    var subtitle: String {
        ...
        case .model:
            return String(localized: "Run NVIDIA's Parakeet model on this Mac, use your own OpenRouter or other provider key, or Yap Cloud if you'd rather not get a key.")
        case .api:
            return String(
                localized:
                    "Yap uses LLMs to enhance transcripts and perform AI actions. Set up an API key before continuing."
            )
        case .experience:
            return String(localized: "Try a few short samples and see how Yap works before you start.")
        case .contextAwareness:
            return String(
    ...
    var descriptor: OnboardingPermissionDescriptor {
        ...
        case .accessibility:
            return OnboardingPermissionDescriptor(
                ...
                subtitle: String(localized: "Yap uses Accessibility to type transcriptions directly into any app.")
            )
