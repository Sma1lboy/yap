...
Product screenshots for GitHub Releases and the READMEs: Home, Account and Modes, light, English (`-en`) and Chinese (`-zh`). 1800×1500 PNG, the main window at its default size (900×750 pt) at 2x.
