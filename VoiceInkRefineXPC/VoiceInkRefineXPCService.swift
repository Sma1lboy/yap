    ...
    func prepare(
        ...
        do {
            ...
            reply(
                makeVoiceInkRefineXPCError(
                    .invalidRequest,
                    description: "Yap Refine received an invalid prepare request."
                )
            )
            return
        }
        ...
        guard didStart else {
            reply(
                makeVoiceInkRefineXPCError(
                    .connectionFailed,
                    description: "Yap Refine is shutting down."
                )
            )
            return
        }
    ...
    func enhance(
        ...
        do {
            ...
            reply(
                ...
                makeVoiceInkRefineXPCError(
                    .invalidRequest,
                    description: "Yap Refine received an invalid enhancement request."
                )
            )
            return
        }
